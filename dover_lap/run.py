...
def read_args():
    ...
    parser = argparse.ArgumentParser(
        description="Apply new DOVER on diarization outputs.",
        add_help=True,
        usage="%(prog)s [options]",
    )
    parser.add_argument("-i", nargs="+", dest="fin", help="Input RTTM files")
    parser.add_argument(
        "-o", nargs="?", default="rttm_out", dest="fout", help="output RTTM file"
    )
    parser.add_argument(
        "-u,--uem",
        nargs=None,
